...
`)}function Up(i,e){let t;switch(e){case vl:t="Linear";break;case xl:t="Reinhard";break;case Ml:t="Cineon";break;case Sl:t="ACESFilmic";break;case yl:t="AgX";break;case Tl:t="Neutral";break;case El:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const br=new L;function Ip(){We.getLuminanceCoefficients(br);const i=br.x.toFixed(4),e=br.y.toFixed(4),t=br.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function Gp(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===qo?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===jc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===pn&&(e="SHADOWMAP_TYPE_VSM"),e}function Wp(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case yi:case Ti:e="ENVMAP_TYPE_CUBE";break;case Or:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Xp(i){let e="ENVMAP_MODE_REFLECTION";return i.envMap&&i.envMapMode===Ti&&(e="ENVMAP_MODE_REFRACTION"),e}function qp(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Yo:e="ENVMAP_BLENDING_MULTIPLY";break;case _l:e="ENVMAP_BLENDING_MIX";break;case gl:e="ENVMAP_BLENDING_ADD";break}return e}function Yp(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function $p(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Gp(t),c=Wp(t),f=Xp(t),h=qp(t),d=Yp(t),m=Np(t),g=Fp(s),M=r.createProgram();let p,u,A=t.glslVersion?"#version "+t.glslVersion+`
...
Program Info Log: `+W+`
`+le+`
`+Ee)}else W!==""?console.warn("THREE.WebGLProgram: Program Info Log:",W):(X===""||Z==="")&&(se=!1);se&&(P.diagnostics={runnable:V,programLog:W,vertexShader:{log:X,prefix:p},fragmentShader:{log:Z,prefix:u}})}r.deleteShader(R),r.deleteShader(w),N=new Dr(r,M),S=Op(r,M)}let N;this.getUniforms=function(){return N===void 0&&C(this),N};let S;this.getAttributes=function(){return S===void 0&&C(this),S};let x=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return x===!1&&(x=r.getProgramParameter(M,Rp)),x},this.destroy=function(){n.releaseStatesOfProgram(this),r.deleteProgram(M),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Cp++,this.cacheKey=e,this.usedTimes=1,this.program=M,this.vertexShader=R,this.fragmentShader=w,this}let Kp=0;class Zp{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new jp(e),t.set(e,n)),n}}class jp{constructor(e){this.id=Kp++,this.code=e,this.usedTimes=0}}function Jp(i,e,t,n,r,s,a){const o=new cc,l=new Zp,c=new Set,f=[],h=r.logarithmicDepthBuffer,d=r.vertexTextures;let m=r.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function M(S){return c.add(S),S===0?"uv":`uv${S}`}function p(S,x,P,O,H){const q=O.fog,W=H.geometry,X=S.isMeshStandardMaterial?O.environment:null,Z=(S.isMeshStandardMaterial?t:e).get(S.envMap||X),V=Z&&Z.mapping===Or?Z.image.height:null,se=g[S.type];S.precision!==null&&(m=r.getMaxPrecision(S.precision),m!==S.precision&&console.warn("THREE.WebGLProgram.getParameters:",S.precision,"not supported, using",m,"instead."));const le=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,Ee=le!==void 0?le.length:0;let Be=0;W.morphAttributes.position!==void 0&&(Be=1),W.morphAttributes.normal!==void 0&&(Be=2),W.morphAttributes.color!==void 0&&(Be=3);let Qe,it,qe,Y;if(se){const Ye=en[se];Qe=Ye.vertexShader,it=Ye.fragmentShader}else Qe=S.vertexShader,it=S.fragmentShader,l.update(S),qe=l.getVertexShaderID(S),Y=l.getFragmentShaderID(S);const j=i.getRenderTarget(),fe=i.state.buffers.depth.getReversed(),Ce=H.isInstancedMesh===!0,Se=H.isBatchedMesh===!0,ke=!!S.map,xt=!!S.matcap,T=!!Z,rt=!!S.aoMap,De=!!S.lightMap,we=!!S.bumpMap,me=!!S.normalMap,st=!!S.displacementMap,_e=!!S.emissiveMap,Ne=!!S.metalnessMap,_t=!!S.roughnessMap,ht=S.anisotropy>0,y=S.clearcoat>0,_=S.dispersion>0,F=S.iridescence>0,G=S.sheen>0,K=S.transmission>0,k=ht&&!!S.anisotropyMap,Me=y&&!!S.clearcoatMap,ne=y&&!!S.clearcoatNormalMap,ge=y&&!!S.clearcoatRoughnessMap,ve=F&&!!S.iridescenceMap,ee=F&&!!S.iridescenceThicknessMap,ce=G&&!!S.sheenColorMap,Ae=G&&!!S.sheenRoughnessMap,xe=!!S.specularMap,ae=!!S.specularColorMap,Le=!!S.specularIntensityMap,D=K&&!!S.transmissionMap,te=K&&!!S.thicknessMap,ie=!!S.gradientMap,he=!!S.alphaMap,J=S.alphaTest>0,$=!!S.alphaHash,pe=!!S.extensions;let Pe=Pn;S.toneMapped&&(j===null||j.isXRRenderTarget===!0)&&(Pe=i.toneMapping);const et={shaderID:se,shaderType:S.type,shaderName:S.name,vertexShader:Qe,fragmentShader:it,defines:S.defines,customVertexShaderID:qe,customFragmentShaderID:Y,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:m,batching:Se,batchingColor:Se&&H._colorsTexture!==null,instancing:Ce,instancingColor:Ce&&H.instanceColor!==null,instancingMorph:Ce&&H.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:j===null?i.outputColorSpace:j.isXRRenderTarget===!0?j.texture.colorSpace:bi,alphaToCoverage:!!S.alphaToCoverage,map:ke,matcap:xt,envMap:T,envMapMode:T&&Z.mapping,envMapCubeUVHeight:V,aoMap:rt,lightMap:De,bumpMap:we,normalMap:me,displacementMap:d&&st,emissiveMap:_e,normalMapObjectSpace:me&&S.normalMapType===Rl,normalMapTangentSpace:me&&S.normalMapType===ic,metalnessMap:Ne,roughnessMap:_t,anisotropy:ht,anisotropyMap:k,clearcoat:y,clearcoatMap:Me,clearcoatNormalMap:ne,clearcoatRoughnessMap:ge,dispersion:_,iridescence:F,iridescenceMap:ve,iridescenceThicknessMap:ee,sheen:G,sheenColorMap:ce,sheenRoughnessMap:Ae,specularMap:xe,specularColorMap:ae,specularIntensityMap:Le,transmission:K,transmissionMap:D,thicknessMap:te,gradientMap:ie,opaque:S.transparent===!1&&S.blending===xi&&S.alphaToCoverage===!1,alphaMap:he,alphaTest:J,alphaHash:$,combine:S.combine,mapUv:ke&&M(S.map.channel),aoMapUv:rt&&M(S.aoMap.channel),lightMapUv:De&&M(S.lightMap.channel),bumpMapUv:we&&M(S.bumpMap.channel),normalMapUv:me&&M(S.normalMap.channel),displacementMapUv:st&&M(S.displacementMap.channel),emissiveMapUv:_e&&M(S.emissiveMap.channel),metalnessMapUv:Ne&&M(S.metalnessMap.channel),roughnessMapUv:_t&&M(S.roughnessMap.channel),anisotropyMapUv:k&&M(S.anisotropyMap.channel),clearcoatMapUv:Me&&M(S.clearcoatMap.channel),clearcoatNormalMapUv:ne&&M(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ge&&M(S.clearcoatRoughnessMap.channel),iridescenceMapUv:ve&&M(S.iridescenceMap.channel),iridescenceThicknessMapUv:ee&&M(S.iridescenceThicknessMap.channel),sheenColorMapUv:ce&&M(S.sheenColorMap.channel),sheenRoughnessMapUv:Ae&&M(S.sheenRoughnessMap.channel),specularMapUv:xe&&M(S.specularMap.channel),specularColorMapUv:ae&&M(S.specularColorMap.channel),specularIntensityMapUv:Le&&M(S.specularIntensityMap.channel),transmissionMapUv:D&&M(S.transmissionMap.channel),thicknessMapUv:te&&M(S.thicknessMap.channel),alphaMapUv:he&&M(S.alphaMap.channel),vertexTangents:!!W.attributes.tangent&&(me||ht),vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,pointsUvs:H.isPoints===!0&&!!W.attributes.uv&&(ke||he),fog:!!q,useFog:S.fog===!0,fogExp2:!!q&&q.isFogExp2,flatShading:S.flatShading===!0&&S.wireframe===!1,sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:h,reversedDepthBuffer:fe,skinning:H.isSkinnedMesh===!0,morphTargets:W.morphAttributes.position!==void 0,morphNormals:W.morphAttributes.normal!==void 0,morphColors:W.morphAttributes.color!==void 0,morphTargetsCount:Ee,morphTextureStride:Be,numDirLights:x.directional.length,numPointLights:x.point.length,numSpotLights:x.spot.length,numSpotLightMaps:x.spotLightMap.length,numRectAreaLights:x.rectArea.length,numHemiLights:x.hemi.length,numDirLightShadows:x.directionalShadowMap.length,numPointLightShadows:x.pointShadowMap.length,numSpotLightShadows:x.spotShadowMap.length,numSpotLightShadowsWithMaps:x.numSpotLightShadowsWithMaps,numLightProbes:x.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:S.dithering,shadowMapEnabled:i.shadowMap.enabled&&P.length>0,shadowMapType:i.shadowMap.type,toneMapping:Pe,decodeVideoTexture:ke&&S.map.isVideoTexture===!0&&We.getTransfer(S.map.colorSpace)===Ze,decodeVideoTextureEmissive:_e&&S.emissiveMap.isVideoTexture===!0&&We.getTransfer(S.emissiveMap.colorSpace)===Ze,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===mn,flipSided:S.side===Pt,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:pe&&S.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(pe&&S.extensions.multiDraw===!0||Se)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return et.vertexUv1s=c.has(1),et.vertexUv2s=c.has(2),et.vertexUv3s=c.has(3),c.clear(),et}function u(S){const x=[];if(S.shaderID?x.push(S.shaderID):(x.push(S.customVertexShaderID),x.push(S.customFragmentShaderID)),S.defines!==void 0)for(const P in S.defines)x.push(P),x.push(S.defines[P]);return S.isRawShaderMaterial===!1&&(A(x,S),b(x,S),x.push(i.outputColorSpace)),x.push(S.customProgramCacheKey),x.join()}function A(S,x){S.push(x.precision),S.push(x.outputColorSpace),S.push(x.envMapMode),S.push(x.envMapCubeUVHeight),S.push(x.mapUv),S.push(x.alphaMapUv),S.push(x.lightMapUv),S.push(x.aoMapUv),S.push(x.bumpMapUv),S.push(x.normalMapUv),S.push(x.displacementMapUv),S.push(x.emissiveMapUv),S.push(x.metalnessMapUv),S.push(x.roughnessMapUv),S.push(x.anisotropyMapUv),S.push(x.clearcoatMapUv),S.push(x.clearcoatNormalMapUv),S.push(x.clearcoatRoughnessMapUv),S.push(x.iridescenceMapUv),S.push(x.iridescenceThicknessMapUv),S.push(x.sheenColorMapUv),S.push(x.sheenRoughnessMapUv),S.push(x.specularMapUv),S.push(x.specularColorMapUv),S.push(x.specularIntensityMapUv),S.push(x.transmissionMapUv),S.push(x.thicknessMapUv),S.push(x.combine),S.push(x.fogExp2),S.push(x.sizeAttenuation),S.push(x.morphTargetsCount),S.push(x.morphAttributeCount),S.push(x.numDirLights),S.push(x.numPointLights),S.push(x.numSpotLights),S.push(x.numSpotLightMaps),S.push(x.numHemiLights),S.push(x.numRectAreaLights),S.push(x.numDirLightShadows),S.push(x.numPointLightShadows),S.push(x.numSpotLightShadows),S.push(x.numSpotLightShadowsWithMaps),S.push(x.numLightProbes),S.push(x.shadowMapType),S.push(x.toneMapping),S.push(x.numClippingPlanes),S.push(x.numClipIntersection),S.push(x.depthPacking)}function b(S,x){o.disableAll(),x.supportsVertexTextures&&o.enable(0),x.instancing&&o.enable(1),x.instancingColor&&o.enable(2),x.instancingMorph&&o.enable(3),x.matcap&&o.enable(4),x.envMap&&o.enable(5),x.normalMapObjectSpace&&o.enable(6),x.normalMapTangentSpace&&o.enable(7),x.clearcoat&&o.enable(8),x.iridescence&&o.enable(9),x.alphaTest&&o.enable(10),x.vertexColors&&o.enable(11),x.vertexAlphas&&o.enable(12),x.vertexUv1s&&o.enable(13),x.vertexUv2s&&o.enable(14),x.vertexUv3s&&o.enable(15),x.vertexTangents&&o.enable(16),x.anisotropy&&o.enable(17),x.alphaHash&&o.enable(18),x.batching&&o.enable(19),x.dispersion&&o.enable(20),x.batchingColor&&o.enable(21),x.gradientMap&&o.enable(22),S.push(o.mask),o.disableAll(),x.fog&&o.enable(0),x.useFog&&o.enable(1),x.flatShading&&o.enable(2),x.logarithmicDepthBuffer&&o.enable(3),x.reversedDepthBuffer&&o.enable(4),x.skinning&&o.enable(5),x.morphTargets&&o.enable(6),x.morphNormals&&o.enable(7),x.morphColors&&o.enable(8),x.premultipliedAlpha&&o.enable(9),x.shadowMapEnabled&&o.enable(10),x.doubleSided&&o.enable(11),x.flipSided&&o.enable(12),x.useDepthPacking&&o.enable(13),x.dithering&&o.enable(14),x.transmission&&o.enable(15),x.sheen&&o.enable(16),x.opaque&&o.enable(17),x.pointsUvs&&o.enable(18),x.decodeVideoTexture&&o.enable(19),x.decodeVideoTextureEmissive&&o.enable(20),x.alphaToCoverage&&o.enable(21),S.push(o.mask)}function E(S){const x=g[S.type];let P;if(x){const O=en[x];P=xu.clone(O.uniforms)}else P=S.uniforms;return P}function R(S,x){let P;for(let O=0,H=f.length;O<H;O++){const q=f[O];if(q.cacheKey===x){P=q,++P.usedTimes;break}}return P===void 0&&(P=new $p(i,x,S,s),f.push(P)),P}function w(S){if(--S.usedTimes===0){const x=f.indexOf(S);f[x]=f[f.length-1],f.pop(),S.destroy()}}function C(S){l.remove(S)}function N(){l.dispose()}return{getParameters:p,getProgramCacheKey:u,getUniforms:E,acquireProgram:R,releaseProgram:w,releaseShaderCache:C,programs:f,dispose:N}}function Qp(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function r(a,o,l){i.get(a)[o]=l}function s(){i=new WeakMap}return{has:e,get:t,remove:n,update:r,dispose:s}}function em(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function Ho(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Vo(){const i=[];let e=0;const t=[],n=[],r=[];function s(){e=0,t.length=0,n.length=0,r.length=0}function a(h,d,m,g,M,p){let u=i[e];return u===void 0?(u={id:h.id,object:h,geometry:d,material:m,groupOrder:g,renderOrder:h.renderOrder,z:M,group:p},i[e]=u):(u.id=h.id,u.object=h,u.geometry=d,u.material=m,u.groupOrder=g,u.renderOrder=h.renderOrder,u.z=M,u.group=p),e++,u}function o(h,d,m,g,M,p){const u=a(h,d,m,g,M,p);m.transmission>0?n.push(u):m.transparent===!0?r.push(u):t.push(u)}function l(h,d,m,g,M,p){const u=a(h,d,m,g,M,p);m.transmission>0?n.unshift(u):m.transparent===!0?r.unshift(u):t.unshift(u)}function c(h,d){t.length>1&&t.sort(h||em),n.length>1&&n.sort(d||Ho),r.length>1&&r.sort(d||Ho)}function f(){for(let h=e,d=i.length;h<d;h++){const m=i[h];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:n,transparent:r,init:s,push:o,unshift:l,finish:f,sort:c}}function tm(){let i=new WeakMap;function e(n,r){const s=i.get(n);let a;return s===void 0?(a=new Vo,i.set(n,[a])):r>=s.length?(a=new Vo,s.push(a)):a=s[r],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function nm(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new L,color:new Ve};break;case"SpotLight":t={position:new L,direction:new L,color:new Ve,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new L,color:new Ve,distance:0,decay:0};break;case"HemisphereLight":t={direction:new L,skyColor:new Ve,groundColor:new Ve};break;case"RectAreaLight":t={color:new Ve,position:new L,halfWidth:new L,halfHeight:new L};break}return i[e.id]=t,t}}}function im(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Oe};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Oe};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Oe,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let rm=0;function sm(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function am(i){const e=new nm,t=im(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new L);const r=new L,s=new ut,a=new ut;function o(c){let f=0,h=0,d=0;for(let S=0;S<9;S++)n.probe[S].set(0,0,0);let m=0,g=0,M=0,p=0,u=0,A=0,b=0,E=0,R=0,w=0,C=0;c.sort(sm);for(let S=0,x=c.length;S<x;S++){const P=c[S],O=P.color,H=P.intensity,q=P.distance,W=P.shadow&&P.shadow.map?P.shadow.map.texture:null;if(P.isAmbientLight)f+=O.r*H,h+=O.g*H,d+=O.b*H;else if(P.isLightProbe){for(let X=0;X<9;X++)n.probe[X].addScaledVector(P.sh.coefficients[X],H);C++}else if(P.isDirectionalLight){const X=e.get(P);if(X.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const Z=P.shadow,V=t.get(P);V.shadowIntensity=Z.intensity,V.shadowBias=Z.bias,V.shadowNormalBias=Z.normalBias,V.shadowRadius=Z.radius,V.shadowMapSize=Z.mapSize,n.directionalShadow[m]=V,n.directionalShadowMap[m]=W,n.directionalShadowMatrix[m]=P.shadow.matrix,A++}n.directional[m]=X,m++}else if(P.isSpotLight){const X=e.get(P);X.position.setFromMatrixPosition(P.matrixWorld),X.color.copy(O).multiplyScalar(H),X.distance=q,X.coneCos=Math.cos(P.angle),X.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),X.decay=P.decay,n.spot[M]=X;const Z=P.shadow;if(P.map&&(n.spotLightMap[R]=P.map,R++,Z.updateMatrices(P),P.castShadow&&w++),n.spotLightMatrix[M]=Z.matrix,P.castShadow){const V=t.get(P);V.shadowIntensity=Z.intensity,V.shadowBias=Z.bias,V.shadowNormalBias=Z.normalBias,V.shadowRadius=Z.radius,V.shadowMapSize=Z.mapSize,n.spotShadow[M]=V,n.spotShadowMap[M]=W,E++}M++}else if(P.isRectAreaLight){const X=e.get(P);X.color.copy(O).multiplyScalar(H),X.halfWidth.set(P.width*.5,0,0),X.halfHeight.set(0,P.height*.5,0),n.rectArea[p]=X,p++}else if(P.isPointLight){const X=e.get(P);if(X.color.copy(P.color).multiplyScalar(P.intensity),X.distance=P.distance,X.decay=P.decay,P.castShadow){const Z=P.shadow,V=t.get(P);V.shadowIntensity=Z.intensity,V.shadowBias=Z.bias,V.shadowNormalBias=Z.normalBias,V.shadowRadius=Z.radius,V.shadowMapSize=Z.mapSize,V.shadowCameraNear=Z.camera.near,V.shadowCameraFar=Z.camera.far,n.pointShadow[g]=V,n.pointShadowMap[g]=W,n.pointShadowMatrix[g]=P.shadow.matrix,b++}n.point[g]=X,g++}else if(P.isHemisphereLight){const X=e.get(P);X.skyColor.copy(P.color).multiplyScalar(H),X.groundColor.copy(P.groundColor).multiplyScalar(H),n.hemi[u]=X,u++}}p>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=re.LTC_FLOAT_1,n.rectAreaLTC2=re.LTC_FLOAT_2):(n.rectAreaLTC1=re.LTC_HALF_1,n.rectAreaLTC2=re.LTC_HALF_2)),n.ambient[0]=f,n.ambient[1]=h,n.ambient[2]=d;const N=n.hash;(N.directionalLength!==m||N.pointLength!==g||N.spotLength!==M||N.rectAreaLength!==p||N.hemiLength!==u||N.numDirectionalShadows!==A||N.numPointShadows!==b||N.numSpotShadows!==E||N.numSpotMaps!==R||N.numLightProbes!==C)&&(n.directional.length=m,n.spot.length=M,n.rectArea.length=p,n.point.length=g,n.hemi.length=u,n.directionalShadow.length=A,n.directionalShadowMap.length=A,n.pointShadow.length=b,n.pointShadowMap.length=b,n.spotShadow.length=E,n.spotShadowMap.length=E,n.directionalShadowMatrix.length=A,n.pointShadowMatrix.length=b,n.spotLightMatrix.length=E+R-w,n.spotLightMap.length=R,n.numSpotLightShadowsWithMaps=w,n.numLightProbes=C,N.directionalLength=m,N.pointLength=g,N.spotLength=M,N.rectAreaLength=p,N.hemiLength=u,N.numDirectionalShadows=A,N.numPointShadows=b,N.numSpotShadows=E,N.numSpotMaps=R,N.numLightProbes=C,n.version=rm++)}function l(c,f){let h=0,d=0,m=0,g=0,M=0;const p=f.matrixWorldInverse;for(let u=0,A=c.length;u<A;u++){const b=c[u];if(b.isDirectionalLight){const E=n.directional[h];E.direction.setFromMatrixPosition(b.matrixWorld),r.setFromMatrixPosition(b.target.matrixWorld),E.direction.sub(r),E.direction.transformDirection(p),h++}else if(b.isSpotLight){const E=n.spot[m];E.position.setFromMatrixPosition(b.matrixWorld),E.position.applyMatrix4(p),E.direction.setFromMatrixPosition(b.matrixWorld),r.setFromMatrixPosition(b.target.matrixWorld),E.direction.sub(r),E.direction.transformDirection(p),m++}else if(b.isRectAreaLight){const E=n.rectArea[g];E.position.setFromMatrixPosition(b.matrixWorld),E.position.applyMatrix4(p),a.identity(),s.copy(b.matrixWorld),s.premultiply(p),a.extractRotation(s),E.halfWidth.set(b.width*.5,0,0),E.halfHeight.set(0,b.height*.5,0),E.halfWidth.applyMatrix4(a),E.halfHeight.applyMatrix4(a),g++}else if(b.isPointLight){const E=n.point[d];E.position.setFromMatrixPosition(b.matrixWorld),E.position.applyMatrix4(p),d++}else if(b.isHemisphereLight){const E=n.hemi[M];E.direction.setFromMatrixPosition(b.matrixWorld),E.direction.transformDirection(p),M++}}}return{setup:o,setupView:l,state:n}}function ko(i){const e=new am(i),t=[],n=[];function r(f){c.camera=f,t.length=0,n.length=0}function s(f){t.push(f)}function a(f){n.push(f)}function o(){e.setup(t)}function l(f){e.setupView(t,f)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:c,setupLights:o,setupLightsView:l,pushLight:s,pushShadow:a}}function om(i){let e=new WeakMap;function t(r,s=0){const a=e.get(r);let o;return a===void 0?(o=new ko(i),e.set(r,[o])):s>=a.length?(o=new ko(i),a.push(o)):o=a[s],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const cm=`void main() {
	gl_Position = vec4( position, 1.0 );
...
`;const Cc=Jn.querySelector(".cabinet"),Pc=Jn.querySelector(".hud-layer"),Dc=Jn.querySelector("#menu-card"),Lc=Jn.querySelector("#countdown"),Uc=Jn.querySelector("#results-card");if(!Cc||!Pc||!Dc||!Lc||!Uc)throw new Error("UI shell did not initialize.");const Tm=Cc,bm=Pc,Es=Dc,Ar=Lc,zi=Uc,Zt=wm(),Da=new Map,rn=new Em({antialias:!0});rn.setPixelRatio(Math.min(window.devicePixelRatio,2));rn.setSize(window.innerWidth,window.innerHeight);rn.setScissorTest(!0);Tm.prepend(rn.domElement);const Pi=new bu;Pi.background=new Ve("#f6e7c3");Pi.fog=new Aa("#f6e7c3",34,100);Pi.add(new Uu(16774354,9479796,1.4));const Ic=new Fu(16774104,1.25);Ic.position.set(22,34,18);Pi.add(Ic);const sn=new gn;Pi.add(sn);Cm(sn);const Am=Rc.map((i,e)=>Dm(bm,e)),At=Rc.map((i,e)=>Lm(e,i,wc[e]??"#ffffff",Am[e]));for(const i of At)sn.add(i.shadow),sn.add(i.tank);let Si=[],Kn=[];const Gi=[],pa=[];let tt="menu",Wo="menu",Zi=3.9,$n=Hr,ys=0,Je=da[0],Un=0,La=!1;Im();Fc(!0);Oc();Fr();o_();window.addEventListener("resize",()=>{rn.setSize(window.innerWidth,window.innerHeight),Vc()});window.addEventListener("keydown",i=>{Da.set(i.code,!0),["ArrowUp","ArrowDown","ArrowLeft","ArrowRight","Space"].includes(i.code)&&i.preventDefault()});window.addEventListener("keyup",i=>{Da.set(i.code,!1)});rn.setAnimationLoop(()=>{const i=Math.min(Vr.getDelta(),.05),e=Nm();zm(e),Vm(i),km(i),Gm(i),Xm(i),Wm(i),qm(i,e),t_(),n_(),i_(),Vc(),r_()});function wm(){try{const i=window.localStorage.getItem(Ac);if(!i)return{autoAccelerate:!0,assistSteering:!0,masterVolume:.7};const e=JSON.parse(i);return{autoAccelerate:e.autoAccelerate??!0,assistSteering:e.assistSteering??!0,masterVolume:e.masterVolume??.7}}catch{return{autoAccelerate:!0,assistSteering:!0,masterVolume:.7}}}function Rm(){window.localStorage.setItem(Ac,JSON.stringify(Zt))}function Cm(i){const e=new Ie(new Ct($t+8,$t+8,.6,48),new Xe({color:"#aacb7b",roughness:1}));e.position.y=-.33,i.add(e);const t=new Ie(new Ct($t+2,$t+2,.18,42),new Xe({color:"#d39b66",roughness:.96}));t.position.y=-.08,i.add(t);const n=new Ie(new Ca($t+.9,1.3,20,48),new Xe({color:"#7f5d39",roughness:.92}));n.rotation.x=Math.PI/2,n.position.y=.35,i.add(n);const r=new Xe({color:"#fff0d3",roughness:.96}),s=new Ie(new Et(88,20,2),r);s.position.set(0,10,-38),i.add(s);const a=new Ie(new Et(2,20,88),r);a.position.set(38,10,0),i.add(a);const o=new Ie(new Et(11,4.5,8),new Xe({color:"#6ac8ff",roughness:.8}));o.position.set(-25,2.2,-19),i.add(o);const l=new Ie(new Ct(.4,.6,7,14),new Xe({color:"#f7deb5",roughness:.92}));l.position.set(24,3.5,23),i.add(l);const c=new Ie(new kt(2.6,18,18),new Xe({color:"#fff3ca",emissive:"#ffd86f",emissiveIntensity:.38}));c.position.set(24,10.4,23),i.add(c);const f=Xo("Toy Box Tanks","#173049","#fff8ea");f.position.set(0,6,-28),i.add(f);const h=Xo("Pop balloons + bonk aliens","#5c4b21","#fff8ea");h.position.set(0,3.2,-28),i.add(h)}function Pm(i){return i.propSpecs.map((e,t)=>{const n=new gn;if(e.kind==="blocks"){const r=new Ie(new Et(3.6,1.6,3.6),new Xe({color:e.color,roughness:.88}));r.position.y=.8,n.add(r);const s=new Ie(new Et(2.1,1.3,2.1),new Xe({color:"#fff3db",roughness:.9}));s.position.y=2.15,n.add(s)}else if(e.kind==="pins")for(const r of[-.95,0,.95]){const s=new Ie(new Ct(.34,.46,2.1,14),new Xe({color:e.color,roughness:.82}));s.position.set(r,1.05,0),n.add(s)}else if(e.kind==="cans")for(const r of[.8,2.15]){const s=new Ie(new Ct(.9,.9,1.35,20),new Xe({color:e.color,roughness:.52,metalness:.15}));s.position.y=r,n.add(s)}else if(e.kind==="cactus"){const r=new Ie(new Ct(.7,.9,3.6,18),new Xe({color:e.color,roughness:.88}));r.position.y=1.8,n.add(r);const s=new Ie(new Ct(.24,.34,1.8,14),new Xe({color:e.color,roughness:.88}));s.position.set(-.95,2.3,0),s.rotation.z=Math.PI/2.7,n.add(s);const a=new Ie(new Ct(.24,.34,1.8,14),new Xe({color:e.color,roughness:.88}));a.position.set(.95,1.65,0),a.rotation.z=-Math.PI/2.7,n.add(a)}else if(e.kind==="snowman"){const r=new Ie(new kt(1,18,18),new Xe({color:e.color,roughness:.92}));r.position.y=1,n.add(r);const s=new Ie(new kt(.72,18,18),new Xe({color:"#f8feff",roughness:.92}));s.position.y=2.15,n.add(s);const a=new Ie(new kt(.48,18,18),new Xe({color:"#ffffff",roughness:.92}));a.position.y=3.05,n.add(a);const o=new Ie(new Ct(.42,.52,.6,18),new Xe({color:"#16324a",roughness:.8}));o.position.y=3.6,n.add(o)}return n.position.set(e.x,0,e.z),n.rotation.y=t*.42,{mesh:n,position:n.position.clone(),baseRotationY:n.rotation.y,tip:new L,tipVelocity:new L,radius:e.kind==="blocks"?2.6:2.1,respawnTimer:0,knockedDown:!1,kind:e.kind,objectiveValue:e.kind==="cactus"||e.kind==="snowman"?1:0}})}function Dm(i,e){const t=document.createElement("div");t.className="player-hud hidden",t.style.borderColor=`${wc[e]}88`;const n=document.createElement("div");n.className="player-name";const r=document.createElement("div");r.className="player-main";const s=document.createElement("div");return s.className="player-sub",t.append(n,r,s),i.append(t),{root:t,name:n,main:r,sub:s}}function Lm(i,e,t,n){const r=new gn,s=new Xe({color:t,roughness:.7}),a=new Xe({color:"#16324a",roughness:.64}),o=new Ie(new Et(2.5,.8,3.3),s);o.position.y=.62,r.add(o);const l=new Ie(new Et(1.5,.7,1.6),a);l.position.set(0,1.15,0),r.add(l);const c=new gn,f=new Ie(new Ct(.82,.82,.42,20),a);f.rotation.x=Math.PI/2,f.position.y=1.18,c.add(f);const h=new Ie(new Ct(.12,.18,2.3,16),new Xe({color:"#fff2cf",roughness:.6}));h.rotation.z=Math.PI/2,h.position.set(1.15,1.18,0),c.add(h),r.add(c);const d=[[-1.05,.35,0],[1.05,.35,0]];for(const[M,p,u]of d){const A=new Ie(new Et(.5,.42,3.45),a);A.position.set(M,p,u),r.add(A)}const m=new Ie(new Ra(1.7,26),new ba({color:"#664c2a",transparent:!0,opacity:.16}));m.rotation.x=-Math.PI/2;const g=new Ht(58,1,.1,200);return{id:i,name:e,color:t,seatState:"waiting",inputSource:null,tank:r,turret:c,barrel:h,shadow:m,camera:g,hud:n,position:new L,velocity:new L,heading:0,turnVelocity:0,recoilTimer:0,reloadTimer:0,hitFlashTimer:0,flapTimer:0,flapDirection:1,visible:!1,state:{score:0,shots:0,place:i+1}}}function Um(i,e){const t=new gn;Nc(t,e,i);const n={mesh:t,kind:e,position:Ua(),velocity:new L,changeTimer:.8+Math.random()*1.5,bobPhase:Math.random()*Math.PI*2,radius:e==="balloon"?1:1.2,points:e==="balloon"?1:2};return Ia(n,!0),n}function Nc(i,e,t){if(i.clear(),e==="balloon"){const a=new Ie(new kt(.85,18,18),new Xe({color:t%2===0?"#ff8db2":"#8ed8ff",roughness:.52,emissive:t%2===0?"#b84f73":"#4a90c3",emissiveIntensity:.12}));a.position.y=1.45,i.add(a);const o=new Ie(new Ct(.03,.03,1.4,8),new Xe({color:"#f4e9cf",roughness:.92}));o.position.y=.65,i.add(o);return}const n=new Ie(new kt(.9,18,18),new Xe({color:"#9df1ad",roughness:.68}));n.position.y=1,i.add(n);const r=new Ie(new kt(.58,18,18),new Xe({color:"#d5ffc8",roughness:.64}));r.position.y=2.05,i.add(r);const s=[-.18,.18];for(const a of s){const o=new Ie(new kt(.08,10,10),new Xe({color:"#16324a",roughness:.5}));o.position.set(a,2.1,.48),i.add(o)}}function Fc(i=!1){i||(ys=(ys+1)%da.length,Je=da[ys]);for(const e of Si)sn.remove(e.mesh);Si=Array.from({length:ym},(e,t)=>Um(t,Je.targetPattern[t%Je.targetPattern.length]));for(const e of Si)sn.add(e.mesh);for(const e of Kn)sn.remove(e.mesh);Kn=Pm(Je);for(const e of Kn)sn.add(e.mesh)}function Ua(){const i=Math.random()*Math.PI*2,e=sc.randFloat(6,$t-5);return new L(Math.cos(i)*e,0,Math.sin(i)*e)}function Ia(i,e=!1){e||i.position.copy(Ua()),i.mesh.position.copy(i.position),i.mesh.position.y=.2,i.mesh.rotation.y=Math.random()*Math.PI*2}function Im(){const i=At[0];i.seatState="active",i.inputSource={kind:"keyboard",label:"Keyboard"},i.visible=!0}function Oc(){$n=Hr,Zi=3.9,tt="menu",Un=0,La=!1;const i=[-Math.PI*.35,Math.PI*.1,Math.PI*.55,Math.PI*.85];At.forEach((e,t)=>{e.state.score=0,e.state.shots=0,e.state.place=t+1,e.recoilTimer=0,e.reloadTimer=0,e.hitFlashTimer=0,e.flapTimer=0,e.flapDirection=1,e.velocity.set(0,0,0),e.turnVelocity=0,e.heading=i[t]??0;const n=10+t*1.8;e.position.set(Math.cos(e.heading)*n,.34,Math.sin(e.heading)*n),e.visible=e.seatState==="active"&&!!e.inputSource,kr(e)});for(const e of Gi)e.active=!1,e.mesh.visible=!1;Si.forEach((e,t)=>{e.velocity.set(0,0,0),e.changeTimer=.6+Math.random()*1.5,e.bobPhase=Math.random()*Math.PI*2,Ia(e)}),Kn.forEach(e=>zc(e))}function Nm(){const i=new Map;for(const e of At){let t=Na();if(e.inputSource?.kind==="keyboard")t=Fm();else if(e.inputSource?.kind==="gamepad"){const r=(navigator.getGamepads?Array.from(navigator.getGamepads()):[])[e.inputSource.gamepadIndex]??null;t=Om(r,e.inputSource.gamepadIndex),r||(e.seatState="disconnected",e.inputSource=null,e.visible=!1)}i.set(e.id,t)}return navigator.getGamepads&&Array.from(navigator.getGamepads()).forEach((e,t)=>{if(!e)return;const n=!!e.buttons[9]?.pressed;vn(`join-${t}`,n)&&Bm(t,e.id||`Gamepad ${t+1}`)}),i}function Na(){return{steer:0,accelerate:!1,brake:!1,firePressed:!1,startPressed:!1,toggleAssistPressed:!1,pausePressed:!1}}function Fm(){const i=Bt("ArrowLeft")||Bt("KeyA"),e=Bt("ArrowRight")||Bt("KeyD");return{steer:(i?1:0)-(e?1:0),accelerate:Bt("ArrowUp")||Bt("KeyW"),brake:Bt("ArrowDown")||Bt("KeyS"),firePressed:vn("kbd-fire",Bt("Space")),startPressed:vn("kbd-start",Bt("Enter")),toggleAssistPressed:vn("kbd-toggle",Bt("KeyT")),pausePressed:vn("kbd-pause",Bt("Escape"))}}function Om(i,e){if(!i)return Na();const t=i.axes[0]??0,n=!!i.buttons[14]?.pressed,r=!!i.buttons[15]?.pressed;return{steer:t>.15||r?Math.min(t||1,1):t<-.15||n?Math.max(t||-1,-1):0,accelerate:!!i.buttons[7]?.pressed,brake:!!i.buttons[6]?.pressed||!!i.buttons[1]?.pressed,firePressed:vn(`gp-fire-${e}`,!!i.buttons[0]?.pressed),startPressed:vn(`gp-start-${e}`,!!i.buttons[9]?.pressed),toggleAssistPressed:vn(`gp-toggle-${e}`,!!i.buttons[3]?.pressed),pausePressed:vn(`gp-pause-${e}`,!!i.buttons[8]?.pressed)}}function vn(i,e){const t=Go.get(i)??!1;return Go.set(i,e),e&&!t}function Bt(i){return Da.get(i)===!0}function Bm(i,e){const t=At.find(r=>r.inputSource?.kind==="gamepad"&&r.inputSource.gamepadIndex===i);if(t){t.seatState="active",t.visible=!0;return}const n=At.find(r=>!r.inputSource);n&&(n.seatState="active",n.inputSource={kind:"gamepad",label:e.split("(")[0].trim()||`Gamepad ${i+1}`,gamepadIndex:i},n.visible=!0,tt==="arena"||tt==="countdown"?Hc(n):kr(n))}function zm(i){const e=Sn(),t=e.some(s=>i.get(s.id)?.startPressed),n=e.some(s=>i.get(s.id)?.toggleAssistPressed),r=e.some(s=>i.get(s.id)?.pausePressed);(tt==="menu"||tt==="countdown")&&n&&(Zt.autoAccelerate=!Zt.autoAccelerate,Rm(),Fr()),tt==="menu"&&t?Hm():tt==="results"&&t?(Fc(),Oc(),Fr()):(tt==="arena"||tt==="countdown")&&r?(Wo=tt,tt="paused"):tt==="paused"&&r&&(tt=Wo)}function Hm(){Sn().length!==0&&(tt="countdown",Zi=3.9,At.forEach(i=>{i.seatState==="active"&&i.inputSource&&(i.visible=!0,Hc(i))}),$n=Hr)}function Vm(i){if(tt==="countdown"){Zi-=i,Zi<=0&&(tt="arena",$n=Hr);return}tt==="arena"&&($n=Math.max(0,$n-i),Un>=Je.objectiveCount?(La=!0,tt="results"):$n<=0&&(tt="results"))}function km(i){Si.forEach(e=>{if(e.changeTimer-=i,e.changeTimer<=0){e.changeTimer=.8+Math.random()*1.6;const t=Ua().sub(e.position).setY(0).normalize().multiplyScalar(1.8+Math.random()*1.6);e.velocity.lerp(t,.8)}e.position.add(e.velocity.clone().multiplyScalar(i)),e.velocity.multiplyScalar(Math.max(0,1-i*1.6)),e.position.length()>$t-3&&(e.position.setLength($t-3),e.velocity.multiplyScalar(-.2)),e.mesh.position.set(e.position.x,.3+Math.sin(Vr.elapsedTime*2+e.bobPhase)*.2,e.position.z),e.mesh.rotation.y+=i*(e.kind==="alien"?.7:.45)})}function Gm(i){for(const e of Kn){if(e.respawnTimer>0){e.respawnTimer-=i,e.respawnTimer<=0&&zc(e);continue}e.tip.add(e.tipVelocity.clone().multiplyScalar(i)),e.tipVelocity.multiplyScalar(Math.max(0,1-i*2.8)),e.tip.multiplyScalar(Math.max(0,1-i*1.6));const t=Math.min(e.tip.length(),.78),n=e.tip.lengthSq()>1e-4?e.tip.clone().normalize():new L(1,0,0);e.mesh.position.copy(e.position),e.mesh.rotation.set(n.z*t,e.baseRotationY,-n.x*t),t>.42&&!e.knockedDown&&(e.knockedDown=!0,Je.objectiveMode==="props"&&e.objectiveValue>0&&(Un=Math.min(Je.objectiveCount,Un+e.objectiveValue)),Zm(e),Jm(e)),t>.55&&e.tipVelocity.length()<.25&&(e.respawnTimer=3.2)}}function Wm(i){for(const e of pa){if(!e.active)continue;if(e.lifetime-=i,e.lifetime<=0){e.active=!1,e.mesh.visible=!1;continue}e.mesh.position.add(e.velocity.clone().multiplyScalar(i)),e.velocity.y-=i*6.2,e.velocity.multiplyScalar(Math.max(0,1-i*1.8)),e.mesh.rotation.x+=i*4.5,e.mesh.rotation.y+=i*5.4;const t=e.mesh.material;t instanceof Xe&&(t.opacity=Math.max(0,e.lifetime/.7))}}function Xm(i){for(const e of Gi)if(e.active){if(e.lifetime-=i,e.lifetime<=0){e.active=!1,e.mesh.visible=!1;continue}if(e.mesh.position.add(e.velocity.clone().multiplyScalar(i)),e.mesh.position.y=.8,e.mesh.position.length()>$t+4){e.active=!1,e.mesh.visible=!1;continue}for(const t of Si)if(t.mesh.position.distanceTo(e.mesh.position)<t.radius){const n=At[e.ownerId];n&&(n.state.score+=t.points),Je.objectiveMode==="targets"&&t.kind==="balloon"&&(Un=Math.min(Je.objectiveCount,Un+1)),e.active=!1,e.mesh.visible=!1,t.kind=Je.targetPattern[Math.floor(Math.random()*Je.targetPattern.length)]??"balloon",t.points=t.kind==="alien"?2:1,t.radius=t.kind==="alien"?1.2:1,Nc(t.mesh,t.kind,Math.floor(Math.random()*100)),Ia(t);break}if(e.active){for(const t of Kn)if(!(t.respawnTimer>0)&&t.mesh.position.distanceTo(e.mesh.position)<t.radius){t.tipVelocity.add(e.velocity.clone().setY(0).normalize().multiplyScalar(2.8)),t.tipVelocity.y=0;const n=At[e.ownerId];n&&(n.state.score+=1),e.active=!1,e.mesh.visible=!1;break}if(e.active){for(const t of At)if(!(!t.visible||t.id===e.ownerId)&&t.position.distanceTo(e.mesh.position)<1.9){Qm(t,e.velocity);const n=At[e.ownerId];n&&(n.state.score+=1),e.active=!1,e.mesh.visible=!1;break}}}}}function qm(i,e){for(const t of At){if(!(t.seatState==="active"&&t.inputSource)){t.visible=!1,t.tank.visible=!1,t.shadow.visible=!1,t.hud.root.classList.add("hidden");continue}t.visible=!0,t.tank.visible=!0,t.shadow.visible=!0;const n=e.get(t.id)??Na();t.recoilTimer=Math.max(0,t.recoilTimer-i),t.reloadTimer=Math.max(0,t.reloadTimer-i),t.hitFlashTimer=Math.max(0,t.hitFlashTimer-i),t.flapTimer=Math.max(0,t.flapTimer-i),tt==="arena"?(Ym(t,n,i),n.firePressed&&$m(t)):t.velocity.multiplyScalar(Math.max(0,1-i*5)),kr(t),e_(t,i)}}function Ym(i,e,t){const n=new L(Math.sin(i.heading),0,Math.cos(i.heading)),r=i.velocity.dot(n),a=Zt.autoAccelerate||e.accelerate?8.6:0,o=e.brake?-6.2:0;i.heading+=e.steer*t*(Math.abs(r)>5?1.65:2.25),i.turret.rotation.y=Math.sin(Vr.elapsedTime*2+i.id)*.05;const l=new L(Math.sin(i.heading),0,Math.cos(i.heading));i.velocity.add(l.clone().multiplyScalar((a+o)*t)),i.velocity.multiplyScalar(Math.max(0,1-t*2.2)),!Zt.autoAccelerate&&!e.accelerate&&!e.brake&&i.velocity.multiplyScalar(Math.max(0,1-t*3.4));const c=Zt.autoAccelerate?11.5:10;if(i.velocity.length()>c&&i.velocity.setLength(c),i.position.add(i.velocity.clone().multiplyScalar(t)),i.position.y=.34,Zt.assistSteering&&i.velocity.lengthSq()>.02){const f=Math.atan2(i.velocity.x,i.velocity.z);i.heading+=a_(i.heading,f)*t*.5}i.position.length()>$t-1.2&&(i.position.setLength($t-1.2),i.velocity.multiplyScalar(-.1))}function $m(i){if(i.reloadTimer>0||tt!=="arena")return;const e=Gi.find(n=>!n.active)??Km();Gi.includes(e)||(Gi.push(e),sn.add(e.mesh));const t=new L(Math.sin(i.heading),0,Math.cos(i.heading)).multiplyScalar(2.2);e.mesh.position.copy(i.position.clone().add(t)),e.mesh.position.y=.8,e.velocity.copy(new L(Math.sin(i.heading),0,Math.cos(i.heading)).multiplyScalar(18)),e.ownerId=i.id,e.lifetime=2.2,e.active=!0,e.mesh.visible=!0,i.state.shots+=1,i.reloadTimer=.32,i.recoilTimer=.12}function Km(){const i=new Ie(new kt(.28,14,14),new Xe({color:"#fff6e8",emissive:"#ffe7b2",emissiveIntensity:.15}));return i.visible=!1,{mesh:i,velocity:new L,ownerId:-1,lifetime:0,active:!1}}function Zm(i){Bc(i.position.clone().add(new L(0,1.2,0)),8,1)}function Bc(i,e,t){const n=Je.id==="bedroom"?{colors:["#fff0b8","#ffd58a","#ffc8df","#f4edd2"],scale:[.26,.18,.06],speed:3.4,life:.6}:Je.id==="kitchen"?{colors:["#f5d18c","#ffedd1","#e8c27a","#fff7e6"],scale:[.18,.18,.18],speed:4.2,life:.7}:Je.id==="desert"?{colors:["#d8b26d","#c99652","#efcf97","#b8894a"],scale:[.22,.22,.22],speed:4.8,life:.75}:{colors:["#ffffff","#dff6ff","#c8ebff","#eefcff"],scale:[.3,.2,.3],speed:3.8,life:.78};for(let r=0;r<e;r+=1){const s=n.colors[r%n.colors.length],a=jm(s,Je.id,n.scale),o=r/Math.max(e,1)*Math.PI*2+Math.random()*.25,l=(n.speed+Math.random()*1.8)*t;a.mesh.position.copy(i),a.mesh.visible=!0,a.active=!0,a.theme=Je.id,a.lifetime=n.life+Math.random()*.12,a.velocity.set(Math.cos(o)*l,2.4+Math.random()*1.4*t,Math.sin(o)*l),a.mesh.rotation.set(Math.random(),Math.random(),Math.random()),a.mesh.scale.set(n.scale[0]+Math.random()*.1,n.scale[1]+Math.random()*.08,n.scale[2]+Math.random()*.1);const c=a.mesh.material;c instanceof Xe&&(c.opacity=1,c.color.set(s))}}function jm(i,e,t){const n=pa.find(o=>!o.active);if(n){const o=n.mesh.material;return o instanceof Xe&&o.color.set(i),n.mesh.scale.set(t[0],t[1],t[2]),n}const r=e==="snow"?new kt(.18,10,10):e==="bedroom"?new Et(.24,.14,.04):e==="kitchen"?new Et(.14,.14,.14):new Et(.18,.18,.18),s=new Ie(r,new Xe({color:i,roughness:.62,transparent:!0,opacity:1}));s.scale.set(t[0],t[1],t[2]),s.visible=!1;const a={mesh:s,velocity:new L,lifetime:0,active:!1,theme:e};return pa.push(a),sn.add(s),a}function Jm(i){for(const e of Kn){if(e===i||e.respawnTimer>0)continue;const t=e.position.clone().sub(i.position),n=t.length();if(n===0||n>7.5)continue;const r=sc.clamp(1-n/7.5,0,1)*1.9;e.tipVelocity.add(t.normalize().multiplyScalar(r))}}function zc(i){i.tip.set(0,0,0),i.tipVelocity.set(0,0,0),i.respawnTimer=0,i.knockedDown=!1,i.mesh.visible=!0,i.mesh.position.copy(i.position),i.mesh.rotation.set(0,i.baseRotationY,0)}function Hc(i){const e=i.id/Math.max(Sn().length,1)*Math.PI*2+Math.PI*.2,t=10+i.id*2;i.position.set(Math.cos(e)*t,.34,Math.sin(e)*t),i.heading=e+Math.PI,i.velocity.set(0,0,0),kr(i)}function kr(i){i.tank.position.copy(i.position),i.tank.rotation.y=i.heading;const e=i.flapTimer>0?Math.sin((1-i.flapTimer/.45)*Math.PI)*.34:0,t=i.hitFlashTimer>0?Math.sin(Vr.elapsedTime*18)*.06:0;i.tank.rotation.z=e*i.flapDirection,i.tank.rotation.x=t,i.shadow.position.set(i.position.x,.04,i.position.z),i.shadow.scale.setScalar(1+i.recoilTimer*.6),i.barrel.position.x=1.15-i.recoilTimer*.35}function Qm(i,e){const t=e.clone().setY(0).normalize(),n=new L(-t.z,0,t.x),r=Math.random()>.5?1:-1,s=Je.id==="bedroom"?{shove:1.6,side:1.9,hit:.22,flap:.26}:Je.id==="kitchen"?{shove:2.1,side:2.5,hit:.3,flap:.34}:Je.id==="desert"?{shove:2.8,side:3.6,hit:.38,flap:.5}:{shove:2.5,side:3.2,hit:.42,flap:.58};i.velocity.add(t.multiplyScalar(s.shove)),i.velocity.add(n.multiplyScalar(s.side*r)),i.hitFlashTimer=s.hit,i.flapTimer=s.flap,i.flapDirection=r,Bc(i.position.clone().add(new L(0,1,0)),6,.8)}function e_(i,e){const t=new L(Math.sin(i.heading),0,Math.cos(i.heading)),n=i.position.clone().add(t.clone().multiplyScalar(-7.2)).add(new L(0,5.2,0));i.camera.position.lerp(n,1-Math.exp(-e*8));const r=i.position.clone().add(t.clone().multiplyScalar(6.2)).add(new L(0,1.2,0));i.camera.lookAt(r)}function t_(){[...Sn()].sort((t,n)=>n.state.score!==t.state.score?n.state.score-t.state.score:t.state.shots-n.state.shots).forEach((t,n)=>{t.state.place=n+1})}function n_(){Sn(),At.forEach(i=>{if(!(i.seatState==="active"&&i.inputSource&&i.visible)){i.hud.root.classList.add("hidden");return}i.hud.root.classList.remove("hidden"),i.hud.name.textContent=`${i.name} ${i.inputSource.kind==="keyboard"?"Keyboard":"Pad"}`,i.hud.main.textContent=`${s_(i.state.place)}  ${i.state.score} pops`,i.hud.sub.textContent=`${Je.title}: ${Un}/${Je.objectiveCount}  •  ${Math.ceil($n)}s`})}function i_(){if(Fr(),tt==="countdown"){Ar.classList.remove("hidden");const i=Math.ceil(Zi);Ar.textContent=i>0?`${i}`:"POP!"}else Ar.classList.add("hidden"),Ar.textContent="";if(tt==="results"){zi.classList.remove("hidden");const i=[...Sn()].sort((e,t)=>e.state.place-t.state.place).map((e,t)=>`
      ...
      <h2 class="title">${Je.title}</h2>
      <p class="subtitle">${La?"Objective cleared.":"Time ran out."} ${Je.objectiveText} Next map starts automatically.</p>
      <div class="result-list">${i}</div>
      <div class="mini-note">Objective: <strong>${Un}/${Je.objectiveCount}</strong> • Auto-Accelerate is <strong>${Zt.autoAccelerate?"On":"Off"}</strong>.</div>
    `}else tt==="paused"?(zi.classList.remove("hidden"),zi.innerHTML=`
    ...
    `):zi.classList.add("hidden")}function Fr(){if(tt!=="menu"&&tt!=="countdown"){Es.classList.add("hidden");return}Es.classList.remove("hidden");const i=Sn(),e=At.map(t=>{const n=t.inputSource?t.inputSource.label:"Press Start to join";return`
        <div class="seat-card">
    ...
    <p class="subtitle">
      ${Je.title}: ${Je.subtitle}
    </p>
    <div class="menu-row">
      <span class="pill is-active">${Je.objectiveText}</span>
  ...
  `}function Sn(){return At.filter(i=>i.seatState==="active"&&!!i.inputSource)}function Vc(){const i=Sn(),e=kc(i.length);i.forEach((t,n)=>{const r=e[n];r&&(t.hud.root.style.left=`${r.x*100+1.2}%`,t.hud.root.style.top=`${r.y*100+1.2}%`,t.hud.root.style.width=`${Math.max(r.width*100-2.4,16)}%`)})}function r_(){rn.clear();const i=Sn();if(i.length===0)return;const e=kc(i.length);i.forEach((t,n)=>{const r=e[n];if(!r)return;const s=Math.max(1,Math.floor(window.innerWidth*r.width)),a=Math.max(1,Math.floor(window.innerHeight*r.height)),o=Math.floor(window.innerWidth*r.x),l=Math.floor(window.innerHeight*(1-r.y-r.height));t.camera.aspect=s/a,t.camera.updateProjectionMatrix(),rn.setViewport(o,l,s,a),rn.setScissor(o,l,s,a),rn.render(Pi,t.camera)})}function kc(i){return i<=1?[{x:0,y:0,width:1,height:1}]:i===2?[{x:0,y:.5,width:1,height:.5},{x:0,y:0,width:1,height:.5}]:[{x:0,y:.5,width:.5,height:.5},{x:.5,y:.5,width:.5,height:.5},{x:0,y:0,width:.5,height:.5},{x:.5,y:0,width:.5,height:.5}]}function s_(i){return i===1?"1st":i===2?"2nd":i===3?"3rd":`${i}th`}function a_(i,e){let t=(e-i+Math.PI)%(Math.PI*2)-Math.PI;return t<-Math.PI&&(t+=Math.PI*2),t}function Xo(i,e,t){const n=document.createElement("canvas");n.width=512,n.height=160;const r=n.getContext("2d");if(!r)return new mo;r.fillStyle=t,r.fillRect(0,0,n.width,n.height),r.strokeStyle="rgba(21,50,74,0.18)",r.lineWidth=8,r.strokeRect(8,8,n.width-16,n.height-16),r.fillStyle=e,r.font="bold 56px Trebuchet MS",r.textAlign="center",r.textBaseline="middle",r.fillText(i,n.width/2,n.height/2);const s=new Pu(n);s.needsUpdate=!0;const a=new mc({map:s,transparent:!0}),o=new mo(a);return o.scale.set(6.4,2,1),o}function o_(){if(!window.location.pathname.includes("toy-box-turbo"))return;const i=document.createElement("script");i.defer=!0,i.src="../../shared/arcade-home.js",i.dataset.arcadeHref="../../index.html",document.body.append(i)}
